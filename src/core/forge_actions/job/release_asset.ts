...
import { GitForgeWorkflowRun, GitForgeWorkflowRunJob, GitForgeWorkflowRunStep } from "#14021226ec9b";
...
type ReleaseAssetContext = {
  emitRunEvent: (
    ...
    input: Omit<import("#14021226ec9b").GitForgeWorkflowRunEvent, "created_at"|"id"|"repository_id"|"run_id"|"sequence"|"workflow_id">,
  ) => Promise<import("#14021226ec9b").GitForgeWorkflowRunEvent>;
