...
const PACKAGE_NAME = toTrimmedString(packageJson?.name) || `@${PACKAGE_ORGANIZATION_NAME}/git-host`;
const PACKAGE_VERSION = toTrimmedString(packageJson?.version, "3.2.2");
const PACKAGE_SLUG = packageSlug(PACKAGE_NAME) || "git-host";
